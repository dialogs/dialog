(function () {
    ...
    _createClass(Form, [{
      ...
      value: function validate(field) {
        ...
        if (isValid) {
          ...
          field.isValid = false; // field.elem.classList.add('error');
  ...
  var OfferModal = /*#__PURE__*/function () {
    ...
    _createClass(OfferModal, [{
      ...
      value: function setModal() {
        ...
        var formElem = offerModal.querySelector('#form-offer-modal');
        var modalProps = {
          modal: offerModal,
  ...
  var main = function main() {
    //region modal
    var openModalButton1 = document.querySelector('.js-open-modal-hero');
    var openModalButton2 = document.querySelector('.js-open-modal-install');
    var formElem = document.querySelector('#form-offer-modal');

    if (openModalButton1) {
      offerModal({
        openButton: openModalButton1
      });
    }

    if (openModalButton2) {
      offerModal({
        openButton: openModalButton2
      });
    }
    ...
    var tabsDesktop = document.querySelectorAll(".tabs__controls .tabs__control");
    var tabsMobile = document.querySelectorAll(".tabs__controls--mobile .tabs__wrapper .tabs__control");
    ...
    if (document.querySelector('.popover--chat-1')) {
      var popperChat1 = document.querySelector('.popover--chat-1');
      var tooltipChat1 = document.querySelector('.tooltip--chat-1');
      var popperChanel1 = document.querySelector('.popover--chanel-1');
      var tooltipChanel1 = document.querySelector('.tooltip--chanel-1');
      var popperChatbot1 = document.querySelector('.popover--chatbot-1');
      var tooltipChatbot1 = document.querySelector('.tooltip--chatbot-1');
      var popperChat2 = document.querySelector('.popover--chat-2');
      var tooltipChat2 = document.querySelector('.tooltip--chat-2');
      var popperChanel2 = document.querySelector('.popover--chanel-2');
      var tooltipChanel2 = document.querySelector('.tooltip--chanel-2');
      var popperChatbot2 = document.querySelector('.popover--chatbot-2');
      var tooltipChatbot2 = document.querySelector('.tooltip--chatbot-2');
      var popperChat3 = document.querySelector('.popover--chat-3');
      var tooltipChat3 = document.querySelector('.tooltip--chat-3');
      var popperChanel3 = document.querySelector('.popover--chanel-3');
      var tooltipChanel3 = document.querySelector('.tooltip--chanel-3');
      var popperChatbot3 = document.querySelector('.popover--chatbot-3');
      var tooltipChatbot3 = document.querySelector('.tooltip--chatbot-3');

      var createInstance = function createInstance(popper, tooltip, placement) {
  ...
  var blog = function blog() {
    var cardsHide = document.querySelectorAll('.blog__item:nth-child(n+8)');
  ...
  var linuxChoiceSelector = document.getElementById('choice-linux');
  ...
  if (linuxChoiceSelector) {
    var linuxChoice = new Choices(linuxChoiceSelector, choiceOptions);
  ...
  var midMax = constants.breakpoints.midMax;
